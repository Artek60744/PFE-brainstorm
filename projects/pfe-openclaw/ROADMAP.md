# Roadmap Implémentation OpenClaw Dashboard
...
#### B. Azure DevOps - Webhook Handler
...
- [ ] Insérer incident dans BD
- [ ] Notifier Teams (canal `#devops-incidents`)
- [ ] Pré-remplir lien vers OpenClaw diagnostic
- **Dépend de** : Webhook ADO configuré en production

#### C. Azure DevOps - Polling Fallback
...
- [ ] Au lieu : call OpenClaw (localhost:8001) pour créer bugs
- [ ] Implémenter client OpenClaw
...
| Token OpenClaw valide (test) | 🔴 ? | OpenClaw deploy | ? |
