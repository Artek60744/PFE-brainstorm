# ADR-001 : OpenClaw comme Framework Agent

## Statut
**Accepté** — Validé par le tuteur
...
## Conséquences
- L'architecture est construite autour d'OpenClaw
- L'équipe doit monter en compétence sur OpenClaw
- La documentation du projet contribuera à l'écosystème OpenClaw
