...
### Q4: OpenClaw Deployment URL & Token
- **Status** : ❌ UNKNOWN
- **Impact** : Blocks Sprint 3 (trust boundary implementation)
- **Needed for** : Dashboard → OpenClaw calls for bug creation
- **Action** : OpenClaw owner → provide deployment details
  - URL (localhost:8001 for dev, prod URL for staging)
  - API token for auth
- **Resolution** : Trust boundary client can authenticate to OpenClaw
